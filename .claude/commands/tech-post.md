...
- 분량: 본문 **3,000~6,000자** — 깊이 있게 쓴다. 각 섹션마다 **개념 설명 + 실제 예제 + 왜/배경 + 흔한 함정·주의점**을 충분히 담고, 필요하면 단계별 절차·비교 표·추가 예제로 확장한다.
  - ⚠ 단, **분량을 위한 채우기·중복·군더더기는 금지**. 모든 문단이 새 정보나 실질적 도움을 줘야 한다. 사실은 여전히 3개 이상 출처로 교차 검증하고, 확인 안 된 내용으로 분량을 늘리지 않는다.
